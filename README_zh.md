...
<p>
  <img src="docs/assets/v0.3.3/menu-panel.png" alt="API Inquiry 菜单栏详情面板" width="360">
</p>

<p>
  <img src="docs/assets/v0.3.3/console-home.png" alt="API Inquiry 控制台首页" width="720">
</p>
...
1. 从 GitHub Releases 下载 `API-Inquiry-v0.3.2.dmg` 和 `API-Inquiry-v0.3.2.dmg.sha256`。
2. 校验下载文件：
