...
```text
dist/API-Inquiry-v0.3.14.dmg
dist/API-Inquiry-v0.3.14.dmg.sha256
```
...
1. Download `API-Inquiry-v0.3.14.dmg` and `API-Inquiry-v0.3.14.dmg.sha256` from GitHub Releases.
