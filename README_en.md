...
```text
dist/API-Inquiry-v0.3.6-Refactor.dmg
dist/API-Inquiry-v0.3.6-Refactor.dmg.sha256
```
...
1. Download `API-Inquiry-v0.3.6-Refactor.dmg` and `API-Inquiry-v0.3.6-Refactor.dmg.sha256` from GitHub Releases.
