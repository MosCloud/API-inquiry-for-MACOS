...
```text
dist/API-Inquiry-v0.3.11.dmg
dist/API-Inquiry-v0.3.11.dmg.sha256
```
...
1. Download `API-Inquiry-v0.3.11.dmg` and `API-Inquiry-v0.3.11.dmg.sha256` from GitHub Releases.
