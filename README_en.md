...
```text
dist/API-Inquiry-v0.3.8.dmg
dist/API-Inquiry-v0.3.8.dmg.sha256
```
...
1. Download `API-Inquiry-v0.3.8.dmg` and `API-Inquiry-v0.3.8.dmg.sha256` from GitHub Releases.
