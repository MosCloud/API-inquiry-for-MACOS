...
- Fixed Auto language mode incorrectly showing Chinese whenever Chinese appeared anywhere in the macOS preferred language list. It now follows the system language order and uses the first supported language.
